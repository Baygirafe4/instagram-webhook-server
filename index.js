...
ПРАЙС-ЛИСТ УСЛУГ (показывай этот список клиенту когда он спрашивает услуги или цены, СОХРАНЯЯ форматирование и эмодзи):
...
13. Когда клиент спрашивает услуги, цены, прайс или "что у вас есть" — покажи ПРАЙС-ЛИСТ УСЛУГ из информации о бизнесе точь-в-точь, сохраняя все эмодзи, номера и форматирование. Не переписывай его своими словами.
14. Когда клиент отвечает номером услуги (например "5" или "номер 5" или "пятое") — определи какая это услуга из прайс-листа и используй её полное название с ценой в заявке. Клиент может ответить и номером, и названием — понимай оба варианта.
15. На польском и английском переведи прайс-лист на соответствующий язык, но сохрани все эмодзи, номера, цены и структуру.
`;
}
